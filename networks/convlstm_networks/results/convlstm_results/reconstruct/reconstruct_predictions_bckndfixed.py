...
if dataset=='lm':
	...
	elif model=='BUnet4ConvLSTM' or model=='unett5' or model=='SkipLSTM' or model=='unet':
	...
	if model=='densenet':
		...
		predictions_path=path+'model_best_BUnet4ConvLSTM_SkipLSTM_64fl_3.h5'
	elif model=='unett5':
		predictions_path=path+'model_best_UNet3D_32fl_T5_1.h5'
	elif model=='unet':
		predictions_path=path+'model_best_BUnet4ConvLSTM_SkipLSTM_64fl_f64_1.h5'
	elif model=='BUnet4ConvLSTM':
		predictions_path=path+'model_best_BUnet4ConvLSTM_64fl_1.h5'
...
if prediction_type=='npy':
	...
	predictions, labels, _ = predictionsLoader.loadPredictions(predictions_path)
